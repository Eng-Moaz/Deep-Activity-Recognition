...
def get_feature_loaders(cfg):
    ...
    train_ds = FeaturesDataset(os.path.join(features_dir, "train_spatial_sequence_features.pt"))
    val_ds = FeaturesDataset(os.path.join(features_dir, "val_spatial_sequence_features.pt"))
    test_ds = FeaturesDataset(os.path.join(features_dir, "test_spatial_sequence_features.pt"))
